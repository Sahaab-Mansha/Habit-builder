...
int _userEstimateSize(
  ...
  bytesCount += 3 + object.babyName.length * 3;
...
void _userSerialize(
  ...
  writer.writeLong(offsets[5], object.streaks);
...
User _userDeserialize(
  ...
  final object = User();
  object.babyName = reader.readString(offsets[0]);
  object.dob = reader.readDateTime(offsets[1]);
  object.gender = reader.readString(offsets[2]);
  object.id = id;
  object.lastLogin = reader.readDateTime(offsets[3]);
  object.password = reader.readString(offsets[4]);
  object.streaks = reader.readLong(offsets[5]);
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> babyNameEqualTo(
    String value, {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'babyName',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> babyNameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'babyName',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> streaksEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'streaks',
        value: value,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> streaksGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> streaksLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> streaksBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  QueryBuilder<User, User, QAfterSortBy> sortByBabyName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'babyName', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByBabyNameDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByStreaks() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streaks', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByStreaksDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streaks', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  QueryBuilder<User, User, QAfterSortBy> thenByBabyName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'babyName', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByBabyNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'babyName', Sort.desc);
    });
  }
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByStreaks() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streaks', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByStreaksDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streaks', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  QueryBuilder<User, User, QDistinct> distinctByBabyName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QDistinct> distinctByStreaks() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'streaks');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String, QQueryOperations> babyNameProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, int, QQueryOperations> streaksProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'streaks');
    });
  }
